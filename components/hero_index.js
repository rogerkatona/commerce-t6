...
export default function HeroIndex({ children, home }) {
    return (
        <section className="bg-gunmetal.500">

 <div className="flex lg:h-screen90vh h-screen90vh bg-cover lg:bg-center bg-center bg-no-repeat flex-col justify-center items-center mt-10">
     <div className="text-9xl text-white.100">FRYTECH</div>
     <div className="text-2xl text-yellow.500">coming soon...</div>
